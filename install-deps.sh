...
mkdir -p /workspaces/codespaces-blank/chrome-profile
...
echo "USER_DATA_DIR=/workspaces/codespaces-blank/chrome-profile" >> .env.local
...
echo "If CHROME_PATH is empty in .env.local, set it to a valid browser binary and re-run npm start."
